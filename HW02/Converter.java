...
/**
 * Represents the thermostats that the company use
 *
 * @author Shaotong Sun
 * @version 2.3
 */
 ...
 */
    ...
    public static double fahrenheitToCelsius(int temp) {
        ...
        double tempCel = ((double) temp - 32) * 5 / 9;
        return tempCel;
    }
    ...
    public static double celsiusToFahrenheit(int temp) {
        ...
        double tempFah = ((double) temp * 9 / 5) + 32;
        return tempFah;
    }
    ...
    public static void printFahrenheitConversionTable(int lower, int upper) {
        ...
        for (int tempF = lower; tempF <= upper; tempF++) {
            double tempC = fahrenheitToCelsius(tempF);
            String ansStr1 = "Fahrenheit: " + tempF;
            String ansStr2 = String.format("Celsius: %.3f", tempC);

            System.out.println(ansStr1 + " -> " + ansStr2);
        }
    }
    ...
    public static void printCelsiusConversionTable(int lower, int upper) {
        ...
        while (tempC <= upper) {
            ...
            String ansStr1 = "Celsius: " + tempC++;
            String ansStr2 = String.format("Fahrenheit: %.3f", tempF);
    ...
    public static boolean celsiusWarmer(int celsius, int fahrenheit) {
        ...
        double tempCtoF = celsiusToFahrenheit(celsius);
        double tempF = fahrenheit;
        return (tempCtoF > tempF);
    }
    ...
    public static boolean fahrenheitWarmer(int fahrenheit, int celsius) {
        ...
        double tempCtoF = celsiusToFahrenheit(celsius);
        double tempF = fahrenheit;
        boolean result = tempF > tempCtoF ? true : false;
        return result;
    }
}
